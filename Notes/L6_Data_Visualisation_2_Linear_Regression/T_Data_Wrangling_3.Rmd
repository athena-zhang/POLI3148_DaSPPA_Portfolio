...
-   `anti_join`: Filter out observations whose identifiers (matching keys) does appeard in the right-hand-side table

-   `semi_join`: Filter out observations whose identifiers (matching keys) does not appear in the right-hand-side table
