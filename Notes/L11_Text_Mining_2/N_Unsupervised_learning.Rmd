...
<https://emilhvitfeldt.github.io/ISLR-tidymodels-labs/12-unsupervised-learning.html>
...
![](Screenshot 2023-12-19 at 5.36.23 pm.png)
...
![](Screenshot 2023-12-19 at 5.37.22 pm.png)
...
![](Screenshot 2023-12-19 at 5.41.06 pm.png)
...
Main Arguments: num_clusters = 3

Engine-Specific Arguments: nstart = 20
...
![](Screenshot 2023-12-19 at 5.43.27 pm.png)
...
![](Screenshot 2023-12-19 at 5.44.48 pm.png)
...
![](Screenshot 2023-12-19 at 5.45.33 pm.png)
...
The [factoextra](https://rpkgs.datanovia.com/factoextra/) package provides functions (`fviz_dend()`) to visualize the clustering created using `hclust()`. We use `fviz_dend()` to show the dendrogram. We need to use the `extract_fit_engine()` to extract the underlying model object that `fviz_dend()` expects.
...
![](Screenshot 2023-12-19 at 5.46.39 pm.png)
...
![](Screenshot 2023-12-19 at 5.46.44 pm.png)
...
![](Screenshot 2023-12-19 at 5.46.50 pm.png)
...
![](Screenshot 2023-12-19 at 5.48.13 pm.png)

## 5. PCA on the NCI60 Data
...
![](Screenshot 2023-12-19 at 5.49.44 pm.png)
...
![](Screenshot 2023-12-19 at 5.50.23 pm.png)
...
![](Screenshot 2023-12-19 at 5.50.28 pm.png)
...
![](Screenshot 2023-12-19 at 5.50.35 pm.png)

## 6. Clustering on nci60 dataset
...
![](Screenshot 2023-12-19 at 5.52.26 pm.png)
...
![](Screenshot 2023-12-19 at 5.52.34 pm.png)
...
![](Screenshot 2023-12-19 at 5.52.39 pm.png)
...
![](Screenshot 2023-12-19 at 5.52.45 pm.png)
...
![](Screenshot 2023-12-19 at 5.54.51 pm.png)
...
![](Screenshot 2023-12-19 at 5.55.41 pm.png)
